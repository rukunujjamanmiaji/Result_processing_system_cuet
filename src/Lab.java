        ...
        if (s.equals("Submit")) {
            ...
            if (((id_number.equals("") || sub.equals("") || regtn.equals("")) || student.equals(""))||(totalcl.equals("") || attendc.equals("") || perf.equals("")) || report.equals("")|| quiz.equals("") || viva.equals(""))  {
                ...
                if (id_number.equals(ID)) {
                    String r = "insert into LAB_MARKS values(" + id_number + "," + sub + "," + student + "," + regtn + "," + totalcl + "," + attendc + "," + perf + "," + report  + "," + quiz + "," + viva + ")";
                    System.out.println(r);

                    try {
                        st.executeQuery(r);
                        JOptionPane.showMessageDialog(this, "Lab marks insertion Successful", "Success", JOptionPane.OK_OPTION);
                    } catch (SQLException ex) {
                        Logger.getLogger(sign_up_head.class.getName()).log(Level.SEVERE, null, ex);
                    }
