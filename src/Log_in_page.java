...
public class Log_in_page extends javax.swing.JFrame {
    ...
    public Log_in_page() {
       ...
       java.awt.GridBagConstraints gridBagConstraints;
        ...
        sign_Teacher.setText("Sign In As A Teacher");
        ...
        jButton2.setText("Sign In As A Student");
        ...
        jButton3.setText("Sign In As A Database OPerator");
        ...
        jButton4.setText("Sign In As A Head");
    ...
    private void sign_TeacherActionPerformed(java.awt.event.ActionEvent evt) {                                             
        Sign_in_Teacher in= new Sign_in_Teacher();
       in.setVisible(true);// TODO add your handling code here:
    }                                            

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       Sign_in_Student in= new Sign_in_Student();
       in.setVisible(true); // TODO add your handling code here:
    }                                        

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       Sign_in_Operator in= new Sign_in_Operator();
       in.setVisible(true);// TODO add your handling code here:
    }                                        

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       Sign_in_head in= new Sign_in_head();
       in.setVisible(true); // TODO add your handling code here:
    }                                        
