 ...
 */
public class Sign_in_Operator extends javax.swing.JFrame {

    /**
     * Creates new form Sign_in_Operator
     */
        ...
        if (s.equals("Submit")) {
            ...
            if (value1.equals("") && value2.equals("")&& value3.equals("")) {
                ...
                try {
                    ...
                    String query = ("SELECT * FROM SIGN_UP_OPERATOR where EMAIL= \'" + value1 + "\'and OPERATOR_ID=\'" + value2 + "\'and PASSWORD=\'" + value3 + "\' ");
                ...
                try {
                    while (result_set.next()) {
                        ...
                        idn = result_set.getString("OPERATOR_ID");
                    }
                } catch (SQLException ex) {
                    Logger.getLogger(Sign_in_Operator.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sign_in_Operator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sign_in_Operator().setVisible(true);
            }
        });
    }
