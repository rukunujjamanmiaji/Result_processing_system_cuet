...
import static result_processing_system.Sign_in_Teacher.st;
 ...
 */
public class Sign_in_head extends javax.swing.JFrame {
    ...
    public Sign_in_head() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(27, 79, 0, 47);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(38, 0, 62, 0);
        getContentPane().add(submit, gridBagConstraints);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel8.setText("HEAD ID                     :");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.ipady = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(90, 143, 0, 0);
        ...
        gridBagConstraints.ipady = 11;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(92, 32, 0, 0);
        ...
        if (s.equals("Submit")) {
            ...
            if (value1.equals("") && value2.equals("") && value3.equals("")&& value4.equals("")) {
                ...
                try {
                    ...
                    String query = ("SELECT * FROM SIGN_UP_HEAD where CUET_MAIL= \'" + value1 + "\'and TEACHER_ID=\'" + value2 + "\'and PASSWORD=\'" + value3 + "\'and HEAD_ID=\'" + value4 + "\' ");
                ...
                try {
                    while (result_set.next()) {
                        ...
                        hidn = result_set.getString("HEAD_ID");
                    }
                } catch (SQLException ex) {
                    Logger.getLogger(Sign_in_Operator.class.getName()).log(Level.SEVERE, null, ex);
                }
                if (value1.equals(name) && value2.equals(idn) && value3.equals(password)&& value4.equals(hidn)) {
                    try {
                        Data_i_d_u_v_s a = new Data_i_d_u_v_s();
                        a.setVisible(true);
                    } catch (Exception ex) {
                        Logger.getLogger(Sign_in_Operator.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sign_in_head.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sign_in_head().setVisible(true);
            }
        });
    }
