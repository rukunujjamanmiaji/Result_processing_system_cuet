 ...
 */
public class Sign_up_Operator extends javax.swing.JFrame {
    /*
     * To change this license header, choose License Headers in Project Properties.
     * To change this template file, choose Tools | Templates
     * and open the template in the editor.
    ...
    public Sign_up_Operator() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(11, 168, 0, 29);
        ...
        jLabel3.setText("Operator's Sign Up Page");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 373, 0, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(66, 49, 0, 0);
        ...
        gridBagConstraints.ipady = 13;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(31, 251, 0, 0);
        ...
        gridBagConstraints.ipady = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(38, 19, 51, 0);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent e) {        
        ...
        if (s.equals("Submit")) {
            ...
            if (((id_number.equals("")) || tname.equals("") || mobileno.equals("") || emailt.equals("") || pass.equals("") || pass2.equals(""))) {
                JOptionPane.showMessageDialog(this, "Please Insert id,name, others", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                String r = "insert into SIGN_UP_OPERATOR values(" + id_number + ",\'" + emailt + "\',\'" + mobileno + "\',\'" + pass + "\',\'" + tname + "\')";
                System.out.println(r);
                
                try {
                    st.executeQuery(r);
                    JOptionPane.showMessageDialog(this, "Operator Sign Up Successful", "Success", JOptionPane.OK_OPTION);
                } catch (SQLException ex) {
                    Logger.getLogger(sign_up_head.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sign_up_Operator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sign_up_Operator().setVisible(true);
            }
        });
    }
