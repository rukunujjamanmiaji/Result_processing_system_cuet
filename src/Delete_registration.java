 ...
 */
public class Delete_registration extends javax.swing.JFrame {
    ...
    public Delete_registration() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(11, 26, 0, 32);
        ...
        jLabel3.setText("Delete Registration");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.ipady = 8;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(11, 270, 0, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(60, 74, 0, 0);
        ...
        reg_type.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"01  Regular", "02  Short Term", "03  Self Study", "04  Backlog"}));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.gridwidth = 5;
        ...
        gridBagConstraints.ipady = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(24, 81, 37, 0);
            ...
            try {
                ...
                if (student.equals(idn) && regtn.equals(regtype)&& sub.equals(subn)) {
                    try {
                     ...
                     String p = " delete from REGISTRATION_TYPE a\n" +
"                            where a.STUDENT_ID=\'" + student + "\'";
                     st.executeQuery(p);
                     System.out.println(p);
                     JOptionPane.showMessageDialog(this, "Registration deletetion successful", "Ok", JOptionPane.OK_OPTION);
                    } catch (Exception ex) {
                        Logger.getLogger(Sign_in_Operator.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    // frame.setVisible(false);
                } else {
                    JOptionPane.showMessageDialog(this, "The student is not registered", "Error", JOptionPane.ERROR_MESSAGE);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_registration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_registration().setVisible(true);
            }
        });
    }
