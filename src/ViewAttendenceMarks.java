 ...
 */
public class ViewAttendenceMarks extends javax.swing.JFrame {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
        ...
        if (id_number.equals("") || sub_n.equals("")) {
            ...
            String query1 = ("SELECT TOTAL_HOUR FROM SUBJECT where SUBJECT_NO= \'" + sub_n + "\'");
            ...
            try {
             ...
             if (credit.equals("2")) {
                String Query = ("select a.STUDENT_ID,b.COURSE_NO,b.COURSE_NAME,a.NO_OF_TOTAL_CLASS,a.NO_OF_ATTENDED_CLASS,round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2) as marks,\n"
                        + "(CASE \n"
                ...
                String Query = ("select a.STUDENT_ID,b.COURSE_NO,b.COURSE_NAME,a.NO_OF_TOTAL_CLASS,a.NO_OF_ATTENDED_CLASS,round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2) as marks,\n"
                        + "(CASE \n"
                        + "  WHEN (round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)>=90)  THEN 40\n"
                        + "  WHEN (round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)<90 and round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)>=85)  THEN 36\n"
                        + "  WHEN (round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)<85 and round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)>=80)  THEN 32\n"
                        + "  WHEN (round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)<80 and round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)>=75)  THEN 28\n"
                        + "  WHEN (round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)<75 and round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)>=70)  THEN 24\n"
                        + "  WHEN (round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)<70 and round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)>=65)  THEN 20\n"
                        + "  WHEN (round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)<65 and round((a.NO_OF_ATTENDED_CLASS/a.NO_OF_TOTAL_CLASS)*100,2)>=60)  THEN 16\n"
                        + "  ELSE 0 \n"
                        + "  END)as student_attendence_marks from ATTENDENCE_MARKS a \n"
                        + "  join SUBJECT b on a.SUBJECT_NO=b.SUBJECT_NO\n"
                        + "  where a.STUDENT_ID=" + id_number + "");
               ...
               JOptionPane.showMessageDialog(this, "This is not a Theoritical subject", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAttendenceMarks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAttendenceMarks().setVisible(true);
            }
        });
    }
