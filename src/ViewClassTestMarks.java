 ...
 */
public class ViewClassTestMarks extends javax.swing.JFrame {
        ...
        submit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(ViewClassTestMarks.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
        ...
        if (id_number.equals("")) {
            ...
            String Query = ("select a.STUDENT_ID,b.COURSE_NO,b.COURSE_NAME,a.CLASS_TEST_1,a.CLASS_TEST_2,a.CLASS_TEST_3,a.CLASS_TEST_4 from CLASS_TEST a\n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewClassTestMarks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewClassTestMarks().setVisible(true);
            }
        });
    }
