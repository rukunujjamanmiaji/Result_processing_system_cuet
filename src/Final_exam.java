...
public class Final_exam extends javax.swing.JFrame {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent e) {
        ...
        if (s.equals("Submit")) {
            ...
            String totalclass = section_a.getText();
            String attenclass = section_b.getText();
            ...
            if (((id_number.equals("") || sub.equals("") || regtn.equals("")) || student.equals("")) || totalclass.equals("") || attenclass.equals("")) {
                ...
                if (id_number.equals(ID)) {
                    String r = "insert into FINAL_EXAM values(" + id_number + "," + sub + "," + student + "," + regtn + "," + totalclass + "," + attenclass + ")";
                    System.out.println(r);

                    try {
                        st.executeQuery(r);
                        JOptionPane.showMessageDialog(this, "Final exam marks insertion Successful", "Success", JOptionPane.OK_OPTION);
                    } catch (SQLException ex) {
                        Logger.getLogger(sign_up_head.class.getName()).log(Level.SEVERE, null, ex);
                    }
