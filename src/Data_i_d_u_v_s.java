 ...
 */
public class Data_i_d_u_v_s extends javax.swing.JFrame {

    /**
     * Creates new form Data_i_d_u_v_s
     */
    public Data_i_d_u_v_s() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(0, 58, 0, 30);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 268, 0, 0);
        ...
        gridBagConstraints.ipady = 8;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(73, 110, 0, 0);
        ...
        gridBagConstraints.ipady = 8;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(47, 110, 83, 0);
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {                                       
        Insert_Data a=new Insert_Data();
        a.setVisible(true);// TODO add your handling code here:
    }                                      

    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {                                       
        Delete_Data a=new Delete_Data();
        a.setVisible(true);// TODO add your handling code here:
    }                                      
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {                                     
        View_Data a=new View_Data();
        a.setVisible(true);// TODO add your handling code here:
    }                                    

    private void searchActionPerformed(java.awt.event.ActionEvent evt) {                                       
        Search_Data a=new Search_Data();
        a.setVisible(true);// TODO add your handling code here:
    }                                      
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_i_d_u_v_s.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Data_i_d_u_v_s().setVisible(true);
            }
        });
    }
