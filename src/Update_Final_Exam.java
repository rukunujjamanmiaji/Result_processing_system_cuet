...
import static result_processing_system.Final_exam.st;
...
public class Update_Final_Exam extends javax.swing.JFrame {

    /**
     * Creates new form Final_exam
     */
    ...
    public Update_Final_Exam() {
       initComponent();
        ...
        section_a = new javax.swing.JTextField();
        section_b = new javax.swing.JTextField();
        ...
        jLabel3.setText("Final Exam Marks");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.ipady = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(25, 46, 0, 0);
        getContentPane().add(jLabel10, gridBagConstraints);

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel11.setText("Section A                              :");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(18, 74, 0, 0);
        getContentPane().add(section_a, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(21, 74, 0, 0);
        getContentPane().add(section_b, gridBagConstraints);

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel12.setText("Section B                              :");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 17;
        gridBagConstraints.ipadx = 43;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(18, 119, 11, 0);
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent e) {                                       
        ...
        if (s.equals("Update")) {
            ...
            String seca = section_a.getText();
            String secb = section_b.getText();

            boolean a = isNumeric(id_number);
            boolean b = isNumeric(sub);
            boolean c = isNumeric(regtn);
            boolean d = isNumeric(student);
            boolean j = isNumeric(seca);
            boolean f = isNumeric(secb);

            if (((id_number.equals("") || sub.equals("") || regtn.equals("")) || student.equals("")) || seca.equals("") || secb.equals("")) {
                ...
                try {
                    String query = ("SELECT TEACHER_ID,STUDENT_ID from FINAL_EXAM where TEACHER_ID= \'" + id_number + "\' and SUBJECT_NO=" + sub +" and STUDENT_ID= \'" + student + "\'");
                ...
                if (id_number.equals(ID) && student.equals(StudentID)) {
                    String r = "update FINAL_EXAM set SECTION_A=" + seca + ",SECTION_B=" + secb + " where TEACHER_ID= " + id_number + " and SUBJECT_NO=" + sub + " and STUDENT_ID =" + student + " and REGISTRATION_TYPE_NO=" + regtn + "";
                    System.out.println(r);

                    try {
                        st.executeQuery(r);
                        JOptionPane.showMessageDialog(this, "final exam marks update Successful", "Success", JOptionPane.OK_OPTION);
                    } catch (SQLException ex) {
                        Logger.getLogger(sign_up_head.class.getName()).log(Level.SEVERE, null, ex);
                    }
 ...
 public void initComponent() 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_Final_Exam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_Final_Exam().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField section_a;
    private javax.swing.JTextField section_b;
