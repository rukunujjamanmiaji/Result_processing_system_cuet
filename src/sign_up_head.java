...
import static result_processing_system.subject.con;

/**
 *
 * @author RUKUNUJJAMAN MIAJI N
 */
public class sign_up_head extends javax.swing.JFrame {
    ...
    public sign_up_head() {
        ...
        head_id = new javax.swing.JTextField();
        ...
        jLabel3.setText("Head Sign Up Page");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        ...
        gridBagConstraints.ipady = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(33, 96, 0, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(36, 11, 0, 23);
        getContentPane().add(head_id, gridBagConstraints);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent e) {
        ...
        if (s.equals("Submit")) {
            ...
            String head_id1 = head_id.getText();
            ...
            boolean i = isNumeric(head_id1);
            if ((id_number.equals("") || tname.equals("") || mobileno.equals("") || emailt.equals("") || cmail.equals("") || pass.equals("") || pass2.equals("") || head_id1.equals(""))) {
                ...
                JOptionPane.showMessageDialog(this, "Please check Head id  and confirm it is integer", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
                try {
                ...
                try {
                    String query = ("SELECT TEACHER_ID from SIGN_UP_TEACHER where TEACHER_ID= \'" + id_number + "\'");
                ...
                if (id_number.equals(ID)) {
                    String r = "insert into SIGN_UP_HEAD values(" + id_number + ",\'" + tname + "\',\'" + emailt + "\',\'" + cmail + "\',\'" + mobileno + "\',\'" + pass + "\'," + head_id1 + ")";
                    System.out.println(r);

                    try {
                        st.executeQuery(r);
                        JOptionPane.showMessageDialog(this, "Head Sign Up Successful", "Success", JOptionPane.OK_OPTION);
                    } catch (SQLException ex) {
                        Logger.getLogger(sign_up_head.class.getName()).log(Level.SEVERE, null, ex);
                    }

                } else {
                    JOptionPane.showMessageDialog(this, "This teacher is not in CSE Department", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sign_up_head.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sign_up_head().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField head_id;
