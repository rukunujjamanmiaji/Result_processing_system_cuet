 ...
 */
public class Attendence_marks extends javax.swing.JFrame {
        ...
        if (s.equals("Submit")) {
            ...
            if (((id_number.equals("") || sub.equals("") || regtn.equals("")) || student.equals("")) || totalclass.equals("") || attenclass.equals("")) {
                ...
                if (id_number.equals(ID)) {
                    String r = "insert into ATTENDENCE_MARKS values(" + id_number + "," + sub + "," + regtn + "," + student + "," + totalclass + "," + attenclass + ")";
                    System.out.println(r);

                    try {
                        st.executeQuery(r);
                        JOptionPane.showMessageDialog(this, "Attendence marks insertion Successful", "Success", JOptionPane.OK_OPTION);
                    } catch (SQLException ex) {
                        Logger.getLogger(sign_up_head.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Attendence_marks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Attendence_marks().setVisible(true);
            }
        });
    }
